...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Ext/Webman - Admin Accounts';
...
CREATE TABLE alias (
  ...
  PRIMARY KEY  (address),
  KEY address (address)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ExtMail - Virtual Aliases';
...
CREATE TABLE domain (
  ...
  PRIMARY KEY  (domain),
  KEY domain (domain)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ExtMail - Virtual Domains';
...
CREATE TABLE domain_manager (
  ...
  active tinyint(1) NOT NULL default '1',
  KEY username (username)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Ext/Webman - Domain Admins';
...
CREATE TABLE mailbox (
  ...
  PRIMARY KEY  (username),
  KEY username (username)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ExtMail - Virtual Mailboxes';
